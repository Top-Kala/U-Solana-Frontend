            ...
            <div>
              ...
              {(phase === Phase.PublicMint || Phase.WhiteListMint) && (
                <>
                    ...
                    <div className="test-stat">
                      {(phase === Phase.WhiteListMint ||
                        ...
                        (itemsAvailable !== null && mintingTotal !== null ? (
                          ...
                          <p className="fontCustom">{mintingTotal + " / " + itemsAvailable}</p>
                        ) : (
                      ...
                      phase === Phase.PublicMint ? (
                        <>
                          {price ? (
                            ...
                            <p className="fontCustom">{price} Sol</p>
                          ) : (
                            <p className="loading"></p>
                          )}
                        </>
                  ...
                  {!wallet.connected ? (
                    <ConnectButton>Mint an Asset{""}</ConnectButton>
                  ) : (
                    <MintContainer className="boxNone"
                    style={{
